...
<<<<<<< HEAD
                        ...
                        <div className="row">
                            ...
                            <div style={{ "marginTop": "7px", "marginLeft": "5px" }}> {this.state.supplierQuote.quantity}</div>
                        </div>
                        <div className="row">
                            <label className="viewLabel">Quote Price :  </label>
                            <div style={{ "marginTop": "7px", "marginLeft": "5px" }}> {this.state.supplierQuote.quotePrice}</div>
=======
                        <div className="row">
                            <label className="viewLabel"> User Name :  </label>
                            <div style={{ "marginTop": "5px", "marginLeft": "5px" }}> {this.state.supplierQuote.userName}</div>
                        </div>
                        <div className="row">
                            <label className="viewLabel">  Product Name :  </label>
                            <div style={{ "marginTop": "5px", "marginLeft": "5px" }}> {this.state.supplierQuote.productName}</div>
                        </div>
                        <div className="row">
                            <label className="viewLabel"> Quantity :  </label>
                            <div style={{ "marginTop": "5px", "marginLeft": "5px" }}> {this.state.supplierQuote.quantity}</div>
                        </div>
                        <div className="row">
                            <label className="viewLabel">Quote Price :  </label>
                            <div style={{ "marginTop": "5px", "marginLeft": "5px" }}> {this.state.supplierQuote.quotePrice}</div>
>>>>>>> f738ce5d3d76db4e2b62b7fe1929fc09f20b132d
                        </div>
